...
-- Introduction of the "Platform Zone": the n°3.
...
begin    
    ...
    -- We set the 'Platform Zone' name. This is a default name that can be changed.
    -- Note that this code is also in the CK.DB.Group.SimpleNaming.Package.Settle script: if the naming
    -- is installed after the Zone support, the 'Platform Zone' name will be correctly initialized.
